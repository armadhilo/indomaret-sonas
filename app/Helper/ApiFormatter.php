...
class ApiFormatter
{
    ...
    protected static $failed_response =  [
        'code' =>  null,
        'data' => null,
        'message' => null,
    ];
    ...
    public static function failed($code, $message, $data = null)
    {
        if($code === 300 || $code === 301){
            self::$failed_response['code'] = $code;
            self::$failed_response['data'] = $data;
            self::$failed_response['message'] = $message;
            return response()->json([
                'code' => self::$failed_response['data'],
                'message' => self::$failed_response['message'],
            ], 203);
        }
    ...
    {
        if($code !== 200 || $code !== 201 || $code !== 300 || $code !== 301 ){
