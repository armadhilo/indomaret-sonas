...
@section('title')
    <h1 class="pagetitle">DAFTAR ITEM YG BLM ADA DI MASTER</h1>
@endsection
            ...
            <div class="col-md-5 col-lg-6 offset-1">
                <div class="card shadow mb-4 vertical-center w-100" id="report_container">
                    <div class="card-body" id="report_content">
                        <div id="header_tb">
                            <h5 class="m-0">Daftar Check Item Yang Belum Ada di Master Lokasi SO</h5>
                        </div>
                        <form id="form_report" method="POST" action="/report/daftar-item-tidak-di-master/show-pdf">
